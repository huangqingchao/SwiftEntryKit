...
DESC
  s.homepage         = 'https://github.com/huangqingchao/SwiftEntryKit'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'huangqc' => 'huangqcmail@icloud.com' }
  s.source           = { :git => 'https://github.com/huangqingchao/SwiftEntryKit', :tag => s.version.to_s }
